...
class OSQuotaSetsV2(object):
    def on_get(self, req, resp, tenant_id, account_id=None):
        qs = {
            ...
            "id": tenant_id,
            "injected_file_content_bytes": cfg.CONF['compute']['default_injected_file_content_bytes'],
            "injected_file_path_bytes": cfg.CONF['compute']['default_injected_file_path_bytes'],
            ...
            "security_group_rules": cfg.CONF['compute']['default_security_group_rules'],
